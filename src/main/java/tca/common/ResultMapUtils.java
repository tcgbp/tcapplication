...
/**
 * @author javachen
 * @description 根据实体类, 生成mybatis的resultMap
 */
public class ResultMapUtils {
    ...
    public static void main(String[] args) {
        System.out.println(getBaseResultMapAndBaseColumnList(User.class));
    }
     ...
     * @return String
     */
    public static String getBaseResultMapAndBaseColumnList(Class<?> clazz) {
        ...
        for (Field f : fields) {
            ...
            resultMap.append("    <result column=\"")
                .append(property2Column(property).toLowerCase())
                .append("\" jdbcType=\"")
                .append(javaType2jdbcType(javaType.toLowerCase()).toLowerCase())
                .append("\" property=\"")
                .append(property)
                .append("\" />\n");
            columns.append(property).append(",");
        }
        resultMap.append("</resultMap>\n");
